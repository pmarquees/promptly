...
import { CreatePromptFormValues, createPromptSchema, Prompt } from "@/lib/types";
...
export function PromptForm({ defaultValues, onSubmit, isEditing = false }: PromptFormProps) {
  ...
  const handleSubmit = (values: CreatePromptFormValues) => {
    const prompt: Prompt = {
      ...
      versions: isEditing && defaultValues?.versions ? defaultValues.versions : [],
      currentVersionId: isEditing && defaultValues?.currentVersionId ? defaultValues.currentVersionId : undefined,
      ...values,
    };
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Optional description to explain the purpose of this prompt.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
